...
void main()
{
	...
	gl_TessLevelOuter[2] = clamp(liness(Input[0].WorldPos, Input[1].WorldPos) * 128, 1, 32);
	gl_TessLevelOuter[0] = clamp(liness(Input[1].WorldPos, Input[2].WorldPos) * 128, 1, 32);
	gl_TessLevelOuter[1] = clamp(liness(Input[2].WorldPos, Input[0].WorldPos) * 128, 1, 32);
