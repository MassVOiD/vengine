...
namespace ShadowsTester
{
    class Commons
    {
        ...
        public static FreeCamera SetUpFreeCamera()
        {
            ...
            var freeCamera = new FreeCamera((float)GLThread.Resolution.Width / (float)GLThread.Resolution.Height, MathHelper.PiOver2);
            FreeCam = freeCamera;
            return freeCamera;
        }
        ...
        public static ProjectionLight AddControllableLight()
        {
            ...
            ProjectionLight redConeLight = new ProjectionLight(new Vector3(65, 0, 65), Quaternion.FromAxisAngle(new Vector3(1, 0, -1), MathHelper.Pi / 2), 4000, 4000, MathHelper.PiOver3, 0.1f, 1000.0f);
