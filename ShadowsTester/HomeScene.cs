...
namespace ShadowsTester
{
    public class HomeScene : Scene
    {
        public HomeScene()
        {
            var testroom = Object3dInfo.LoadSceneFromObj(Media.Get("dupa.obj"), Media.Get("dupa.mtl"), 3.0f);
            //var instances = InstancedMesh3d.FromMesh3dList(testroom);
            testroom[1].MainMaterial.Color = new Vector4(0.67f, 0.67f, 0.67f, 1);
            testroom[1].MainMaterial.Roughness = 0.8f;
            testroom[1].MainMaterial.Metalness = 0;
            testroom[0].MainMaterial.Color = new Vector4(1, 0, 0, 1);
            testroom[0].MainMaterial.Roughness = 0.99f;
            testroom[0].MainMaterial.Metalness = 0;
